...
-   run RevBayes scripts like this: `rb scripts/GeoSSE-model.Rev`
...
trace <- read.table(
  paste0(here::here(), "/data/output/GeoSSE/model.log"),
  header = TRUE
)
...
tree_file <- paste0(here::here(), "/data/output/GeoSSE/ase.tre")
...
fp <- paste0(here::here(), "/data/output/GeoSSE/")
...
labs <- c("0" = "Afr", "1" = "Mdg", "2" = "both", "3" = "none")
...
ggsave(pp, filename = paste0(here::here(), "figures/final_GeoSSE_ACR.png"))
```